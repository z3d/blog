...
The implementation uses Ledoit-Wolf shrinkage as a guardrail. In practical terms, when the exemplar set is too small to trust the feature relationships, the score is pulled back towards a simpler standardised distance. When there is more evidence for those relationships, they influence the score more. I needed the models to help me get to that design, and then the reports made it clear whether the result was useful.
